...
Mobile.startApplication('C:\\Users\\LENOVO\\Downloads\\app-sit-universal-release (1).apk', true)
...
Mobile.setText(findTestObject('Maya/login again/android.widget.EditText0'), 'webuiux04', 0)
...
Mobile.setText(findTestObject('Maya/login again/android.widget.EditText0 (1)'), 'webuiux04a', 0)
...
Mobile.tap(findTestObject('Maya/Investment/android.widget.TextView0 - Savings Account-i'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.tap(findTestObject('Maya/Investment/android.widget.TextView0 - Maybank2u'), 0)

Mobile.delay(3, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.swipe(239, 352, 50, 352)
Mobile.delay(3, FailureHandling.CONTINUE_ON_FAILURE)
Mobile.swipe(239, 352, 50, 352)
Mobile.delay(3, FailureHandling.CONTINUE_ON_FAILURE)
Mobile.swipe(239, 352, 50, 352)
...
Mobile.delay(3, FailureHandling.CONTINUE_ON_FAILURE)
Mobile.swipe(239, 352, 50, 352)
Mobile.tap(findTestObject('Maya/Investment/android.widget.TextView0 - INVESTMENTS'), 0)

Mobile.getText(findTestObject('Maya/Investment/android.widget.TextView0 - Master Foreign Currency Account'), 0)

Mobile.getText(findTestObject('Maya/Investment/android.widget.TextView0 - JPY'), 0)

Mobile.getText(findTestObject('Maya/Investment/android.widget.TextView0 - Master Foreign Currency Account (1)'), 0)

Mobile.getText(findTestObject('Maya/Investment/android.widget.TextView0 - SGD'), 0)
