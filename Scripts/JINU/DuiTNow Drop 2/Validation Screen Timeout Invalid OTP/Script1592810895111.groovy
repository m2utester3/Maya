...
Mobile.verifyElementExist(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - OTP cant be less than 6 digits.'), 
    0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/Mobile proxy/android.widget.TextView0 - Wrong OTP entered'), 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Maya/DuitNow Drop 2-NRIC Proxy/Failed'), 0)

Mobile.verifyElementExist(findTestObject('Maya/DuitNow Drop 2-NRIC Proxy/android.widget.ImageView0-Close button'), 0)

Mobile.tap(findTestObject('Maya/DuitNow Drop 2-NRIC Proxy/android.widget.TextView0 - Try Again'), 0)
