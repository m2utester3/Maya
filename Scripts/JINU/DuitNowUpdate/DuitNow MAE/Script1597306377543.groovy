...
Mobile.tap(findTestObject('Maya/duitnow/android.widget.TextView0 - Wallet'), 0)
...
if (Mobile.getText(findTestObject('Maya/duitnow/android.widget.TextView0 - MAE'), 0)) {
...
} else if (Mobile.verifyElementNotVisible(findTestObject('Maya/duitnow/android.widget.TextView0 - MAE'), 0, FailureHandling.CONTINUE_ON_FAILURE)) {
    Mobile.tap(findTestObject('Maya/duitnow/android.widget.ImageView0 (9)'), 0)

    Mobile.tap(findTestObject('Maya/duitnow/android.view.ViewGroup0 (2)'), 0)

    Mobile.tap(findTestObject('Maya/duitnow/android.widget.TextView0 - MAE (1)'), 0)

    Mobile.tap(findTestObject('Maya/duitnow/android.widget.TextView0 - Confirm'), 0)
	Mobile.tap(findTestObject('duitnow/android.widget.TextView0 - Transfer'), 0)
	Mobile.setText(findTestObject('duitnow/android.widget.EditText0'), 'pass1234', 0)
	driver.pressKeyCode(AndroidKeyCode.ENTER)
