...
Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - Save with Tabung'), 0)

Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - Add a Tabung now to get started on saving up for your goals.'), 
    0)
...
Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - Create Tabung (1)'), 0)
...
Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - RM  1.00 (1)'), 0)

Mobile.tap(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - RM  1.00 (1)'), 0)

Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - Cancel'), 0)

Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - RM  1.00 (2)'), 0)
...
Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - Change your overspending habits for the better with this Booster.'), 
    0)
...
Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - Health  Beauty'), 0)

Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - Shopping (1)'), 0)

Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - Leisure  Sports'), 0)

Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - Food  Beverage'), 0)

Mobile.tap(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - Food  Beverage'), 0)
...
Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - Want to start saving Start a Tabung now and add a Booster to it. (1)'), 
    0)

Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - Create Tabung (2)'), 0)

Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - You may only add a Booster to an active Tabung. If you have created two Tabung and added the same Booster to both the amount will be distributed evenly.'), 
    0)
...
Mobile.tap(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - Health  Beauty'), 0)
...
Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.EditText0 - 0.20'), 0)
...
Mobile.getText(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - View Details (2)'), 0)

Mobile.tap(findTestObject('MAYA Drop 2/Tabung - BOOSTERS/android.widget.TextView0 - View Details (2)'), 0)
