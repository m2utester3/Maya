...
Mobile.verifyEqual(var18, 'Reference 2 (Optional)')
...
Mobile.tap(findTestObject('MAYA Drop 2/PayBills-Jompay/spy/UAT - Bills TAC OK btn'), 0, FailureHandling.CONTINUE_ON_FAILURE)
...
def otpJom = Mobile.getText(findTestObject('MAYA Drop 2/Forgot M2U Login/spy/Fortgot Login - OTP number'), 0)
