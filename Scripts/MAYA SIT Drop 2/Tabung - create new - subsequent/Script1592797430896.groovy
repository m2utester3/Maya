...
not_run: if (Mobile.verifyElementExist(findTestObject('MAYA Drop 2/Tabung-create new/android.widget.TextView0 - Create Tabung'), 
    0)) {
    ...
    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 41'), 0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 42'), 0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 43'), 0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 44'), 0)

    Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 41'), 0)

    Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 45'), 0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 46'), 0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 47'), 0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 48'), 0)

    Mobile.tap(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 49'), 0, FailureHandling.CONTINUE_ON_FAILURE)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 50'), 0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 51'), 0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 52'), 0)

    Mobile.getText(findTestObject('MAYA Drop 2/Tabung-create new/tabung SPY/tabung - create new confirm 53'), 0)
...
if (Mobile.verifyElementExist(findTestObject('MAYA Drop 2/Tabung-create new/Tabung - createnew - New Tabung/tabung - create new - Tap to view'), 
    0)) {
