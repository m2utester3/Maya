...
Mobile.setText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.EditText0'), 'pass1234', 0)
...
not_run: Mobile.swipe(500, 1400, 500, 1600)
...
Mobile.tap(findTestObject('MAYA Drop 2/General Settings 2/android.widget.ImageView0 (4)'), 0)
...
Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - Wrong PIN entered'), 0)
...
Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - katalon'), 0)
...
Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - CREATE CONTACT'), 0)

Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - UPDATE EXISTING'), 0)

Mobile.getText(findTestObject('MAYA Drop 2/General Settings 2/android.widget.EditText0 - 60358914744'), 0)
...
Mobile.tap(findTestObject('MAYA Drop 2/General Settings 2/android.widget.TextView0 - Support (1)'), 0)
